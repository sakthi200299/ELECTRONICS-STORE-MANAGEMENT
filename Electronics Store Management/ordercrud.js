...
function updateOrder(event) {
    ...
    fetch(`http://localhost:8356/orders/update/${updateOrderId}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
...
function deleteOrder(event) {
    ...
    fetch(`http://localhost:8356/orders/delete/${deleteOrderId}`, {
        method: 'DELETE'
    })
    .then(response => {
        if (response.ok) {
...
function approveOrder(orderId) {
    fetch(`http://localhost:8356/orders/approve/${orderId}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        }
